    ...
    <form id="form1"  runat="server">
        <div id="formLogin">
            ...
            <br />
                ...
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Digite o Email" ControlToValidate="TextEmail" ForeColor="Red" ValidationGroup="validacao" Font-Size="Small"></asp:RequiredFieldValidator>
                <br />
                 
                <asp:Textbox ID="TextSenha" CssClass="TextBox" runat="server" TextMode="Password" placeholder="Senha" ></asp:Textbox>
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Digite a senha" ControlToValidate="TextSenha" ForeColor="Red" ValidationGroup="validacao" Font-Size="Small"></asp:RequiredFieldValidator>
                <br />
